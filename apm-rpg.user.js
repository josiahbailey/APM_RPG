...
(function () {
  ...
  GM_addStyle([
    ...
    '.rpg-panel-tab{width:26px;height:90%;align-self:center;margin-right:-6px;background:rgba(20,20,28,0.85);color:#ffd166;border:1px solid #3b3b48;border-right:none;border-radius:8px 0 0 8px;cursor:pointer;writing-mode:vertical-rl;text-orientation:mixed;display:flex;align-items:center;justify-content:center;font-weight:800;letter-spacing:3px;font-size:12px;user-select:none;transition:background 150ms,color 150ms;backdrop-filter:blur(2px);box-shadow:-3px 0 8px rgba(0,0,0,0.3)}',
