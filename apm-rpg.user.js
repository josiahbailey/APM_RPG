...
(function () {
  ...
  GM_addStyle([
    ...
    '.rpg-panel{position:fixed;right:16px;bottom:16px;z-index:2147483000;background:rgba(20,20,28,0.3);color:#eee;border:1px solid #3b3b48;border-radius:12px;padding:10px;display:flex;gap:10px;align-items:center;box-shadow:0 8px 24px rgba(0,0,0,0.5);backdrop-filter:blur(2px);user-select:none}',
    ...
    '.rpg-panel{background-color:rgba(20,20,28,0.3);background-repeat:no-repeat}',
  ...
  const applyBanner = () => {
    ...
    if (b && b.img) {
      el.panel.style.backgroundImage =
        'linear-gradient(rgba(20,20,28,0.3), rgba(20,20,28,0.35)), url("' + b.img + '")';
