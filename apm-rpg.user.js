...
(function () {
  ...
  // Asset base — images live in the repo alongside this script.
  ...
  const BANNERS = [
    ...
    { id: 'bn_forest',    img: IMG_BASE + '/Banner_Images/Banner_1.png',    level: 3 },
    { id: 'bn_desert',    img: IMG_BASE + '/Banner_Images/Banner_2.png',    level: 6 },
    { id: 'bn_snow',      img: IMG_BASE + '/Banner_Images/Banner_3.png',    level: 9 },
    { id: 'bn_nightsky',  img: IMG_BASE + '/Banner_Images/Banner_4.png',    level: 12 },
    { id: 'bn_volcano',   img: IMG_BASE + '/Banner_Images/Banner_5.png',    level: 15 },
    { id: 'bn_ocean',     img: IMG_BASE + '/Banner_Images/Banner_6.png',    level: 18 },
    { id: 'bn_meadow',    img: IMG_BASE + '/Banner_Images/Banner_7.png',    level: 21 },
    { id: 'bn_void',      img: IMG_BASE + '/Banner_Images/Banner_8.png',    level: 24 },
    { id: 'bn_gold',      img: IMG_BASE + '/Banner_Images/Banner_9.png',    level: 27 },
    { id: 'bn_prismatic', img: IMG_BASE + '/Banner_Images/Banner_10.png',   level: 30 },
  ];
  ...
  // 28 pets total. catchBaseRate + spawnWeight are derived from RARITY_META below.
  //   Common (10), Rare (7), Epic (5), Legendary (4), Ancient (2)
  const PETS = [
    // ── Common (10) ─────────────────────────────────────────────
    { id: 'pt_icedro',    name: 'Chillup',   rarity: 'Common',    img: IMG_BASE + '/Pet_Images/Common/Chillup.png'  },
    { id: 'pt_duskat',    name: 'Duskat',    rarity: 'Common',    img: IMG_BASE + '/Pet_Images/Common/Duskat.png'   },
    { id: 'pt_fasfox',    name: 'Fasfox',    rarity: 'Common',    img: IMG_BASE + '/Pet_Images/Common/Fasfox.png'   },
    { id: 'pt_bagroc',    name: 'Ingot',     rarity: 'Common',    img: IMG_BASE + '/Pet_Images/Common/Ingot.png'    },
    { id: 'pt_windro',    name: 'Kindlet',   rarity: 'Common',    img: IMG_BASE + '/Pet_Images/Common/Kindlet.png'  },
    ...
    { id: 'pt_flarret',   name: 'Flarret',   rarity: 'Rare',      img: IMG_BASE + '/Pet_Images/Rare/Flarret.png'    },
    ...
    { id: 'pt_sunbun',    name: 'Sunbun',    rarity: 'Rare',      img: IMG_BASE + '/Pet_Images/Rare/Sunbun.png'     },
    // ── Epic (5) ────────────────────────────────────────────────
    { id: 'pt_blazlynx',  name: 'Blazlynx',  rarity: 'Epic',      img: IMG_BASE + '/Pet_Images/Epic/Blazlynx.png'   },
    { id: 'pt_wolverice', name: 'Blizzen',   rarity: 'Epic',      img: IMG_BASE + '/Pet_Images/Epic/Blizzen.png'    },
    ...
    // ── Ancient (2) ─────────────────────────────────────────────
    { id: 'pt_galactal',  name: 'Galactal',  rarity: 'Ancient',   img: IMG_BASE + '/Pet_Images/Ancient/Galactal.png'   },
  ...
  GM_addStyle([
    ...
    '.rpg-panel-wrap.rpg-collapsed{transform:translateX(calc(100% - 16px))}',
    '.rpg-panel-tab{width:26px;align-self:stretch;margin-right:-6px;background:rgba(20,20,28,0.65);color:#ffd166;border:1px solid #3b3b48;border-right:none;border-radius:8px 0 0 8px;cursor:pointer;writing-mode:vertical-rl;text-orientation:mixed;display:flex;align-items:center;justify-content:center;font-weight:800;letter-spacing:3px;font-size:12px;user-select:none;transition:background 150ms,color 150ms;backdrop-filter:blur(2px);box-shadow:-3px 0 8px rgba(0,0,0,0.3)}',
    '.rpg-panel-tab:hover{background:rgba(40,40,55,0.75);color:#fff}',
      ...
      for (const c of CHARACTERS) {
        ...
        const tile = $('div', {
          ...
          onclick: () => {
            ...
            // Refresh the .active class across the whole slider so the gold
            // outline moves with the current selection.
            charRow.querySelectorAll('.rpg-menu-char').forEach((el2) => {
              el2.classList.toggle('active', el2.dataset.characterId === state.equip.characterId);
            });
          }
        });
        tile.dataset.characterId = c.id;
  ...
  const showStarterModal = () => {
    ...
    for (const p of STARTER_IDS.map(id => PETS.find(pt => pt.id === id)).filter(Boolean)) {
      const card = $('div', {
